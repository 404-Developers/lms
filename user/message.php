<?php  
 ...
 $return=$_GET['return'];
        ...
        if($diff>=0)
        {
          ...
          $fine= $day*5;   //rs 5 for  1 expired date
        }
		...
		<div class="srch">
			...
			<form class="col-5 border border-secondary rounded" style="margin:auto; padding:10px; width:400px;" method="post" action="" name="form1">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="username" value="<?php echo $email; ?>" style="background-color:#213438;" readonly >
                </div>
                <div class="form-group">
					<label>Fine</label>
					<input type="text" class="form-control" name="fine" value="<?php echo $fine; ?>" style="background-color:#213438;" readonly >
				</div>
				<div class="form-group">
					<label>Book Id</label>
